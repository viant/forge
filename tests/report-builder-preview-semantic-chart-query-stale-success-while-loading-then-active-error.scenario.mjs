...
export default {
  ...
  steps: [
    ...
    {
      type: "screenshot",
      file: "report-builder-preview-semantic-chart-query-stale-success-while-loading-then-active-error.png",
      fullPage: true,
    },
  ],
};
