...
export default {
  ...
  steps: [
    ...
    {
      type: "waitForEval",
      expression: "(() => (document.querySelector('.forge-report-builder__result-header h3')?.innerText || '').includes('Delivery Grid'))()",
      timeoutMs: 60000,
    },
    {
      type: "waitForDomContains",
    ...
    {
      type: "waitForDomContains",
      text: "Dimensions Delivery Date, Channel +1",
      timeoutMs: 60000,
    },
    {
      type: "waitForDomContains",
    ...
    {
      type: "screenshot",
      file: "report-builder-preview-semantic-active-delivery-grid.png",
      fullPage: true,
    },
  ],
};
