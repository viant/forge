...
export default {
  ...
  steps: [
    ...buildInlineArtifactImportSteps({
      ...
      filename: "capacity-trend.active-lifecycle.published-snapshot.json",
    ...
    },
    {
      ...
      expression: `(() => {
        ...
        return text.includes('published-snapshot artifact') && buttons.includes('Archive');
      })()`,
      timeoutMs: 60000,
    },
    buildSectionButtonClickStep({
    ...
    },
    {
      ...
      expression: `(() => {
        ...
        return text.includes('published_snapshot_capacityTrendQ3_1')
    ...
    {
      type: "screenshot",
      file: "report-builder-preview-semantic-import-published-snapshot-lifecycle-archive.png",
      fullPage: true,
    },
  ],
};
