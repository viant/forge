import baseScenario from "./report-builder-preview-semantic-import-report-fill-detach-report-spec-export-request.scenario.mjs";
...
export default {
  ...
  steps: [
    ...
    {
      type: "waitForEval",
      expression: "(() => { const text = document.body?.innerText || document.body?.textContent || ''; return text.includes('Semantic Binding') && text.includes('Model Ad Delivery') && text.includes('Entity Line Delivery') && text.includes('Available Impressions') && text.includes('PREVIEW FILL') && text.includes('demo-export-job-submit-failed-fill-detach') && text.includes('failed') && !text.includes('demo-export-job-1'); })()",
      timeoutMs: 60000,
    },
    {
      type: "waitForEval",
    ...
    {
      type: "screenshot",
      file: "report-builder-preview-semantic-import-report-fill-detach-report-spec-export-submit-failure.png",
      fullPage: true,
    },
  ],
};
