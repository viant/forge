...
export default {
  ...
  steps: [
    ...buildInlineArtifactImportSteps({
      ...
      filename: "capacity-trend.saved-view.saved-record.json",
    ...
    }),
    {
      ...
      expression: `(() => {
        ...
        const file = new File([JSON.stringify(artifact, null, 2)], 'capacity-trend.published-snapshot.saved-record.json', { type: 'application/json' });
    ...
    ...buildInlineArtifactImportSteps({
      ...
      filename: "capacity-trend.saved-view.list-response.json",
    ...
    {
      type: "screenshot",
      file: "report-builder-preview-semantic-list-entry-saved-view-export-request.png",
      fullPage: true,
    },
  ],
};
