...
export default {
  ...
  steps: [
    ...
    },
    {
      ...
      text: "Click a chart mark or series legend to apply authored runtime actions.",
    },
    {
      type: "waitForEval",
    ...
    {
      type: "waitForEval",
      expression: "(() => { const panel = document.querySelector('.forge-report-runtime-host-intent'); const text = panel?.innerText || panel?.textContent || ''; return text.includes('Resolved detail target') && text.includes('target://example/performance/channel-detail') && text.includes('channel') && text.includes('Display'); })()",
      timeoutMs: 60000,
    },
    {
      type: "screenshot",
      file: "report-builder-preview-runtime-multiseries-proof.png",
      fullPage: true,
    },
  ],
};
