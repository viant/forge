...
export default {
  ...
  steps: [
    ...
    {
      type: "screenshot",
      file: "report-builder-preview-semantic-recovery-proof.png",
      fullPage: true,
    },
  ],
};
