...
export default {
  ...
  steps: [
    ...
    {
      type: "waitForDomContains",
      text: "Get ReportDocument request: Capacity Locations Top Markets Q3",
      timeoutMs: 60000,
    },
    {
      type: "assertDomNotContains",
    ...
    {
      type: "screenshot",
      file: "report-builder-preview-semantic-reopen-selected-get-report-document-location-chart-validation-retry.png",
      fullPage: true,
    },
  ],
};
