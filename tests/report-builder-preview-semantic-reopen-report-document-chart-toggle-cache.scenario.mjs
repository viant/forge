...
export default {
  ...
  steps: [
    ...
    ...buildChartQueryBaselineResetSteps({
      baselineKey: "__reopenedChartToggleCacheBaseline",
    ...
    {
      type: "screenshot",
      file: "report-builder-preview-semantic-reopen-report-document-chart-toggle-cache.png",
      fullPage: true,
    },
  ],
};
