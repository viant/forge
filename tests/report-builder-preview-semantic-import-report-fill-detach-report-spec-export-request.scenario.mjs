...
export default {
  ...
  steps: [
    ...
    buildAriaSectionButtonClickStep({
      ...
      buttonTexts: ["Detach ReportFill"],
      missingSectionMessage: "imported runtime section not found",
      missingButtonMessage: "detach button not found",
    }),
    {
      type: "waitForDomContains",
      text: "Attach ReportFill",
      timeoutMs: 60000,
    },
    {
      type: "waitForEval",
    ...
    {
      type: "screenshot",
      file: "report-builder-preview-semantic-import-report-fill-detach-report-spec-export-request.png",
      fullPage: true,
    },
  ],
};
