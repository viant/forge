...
export default {
  ...
  steps: [
    ...
    },
    {
      ...
      text: "Location Ladder",
      index: 0,
    },
    {
      type: "waitForDomContains",
      text: "CAPACITY LOCATION",
      timeoutMs: 60000,
    },
    {
      type: "waitForDomContains",
      text: "Region -> Metro Area",
      timeoutMs: 60000,
    },
    {
      type: "waitForDomContains",
    ...
    {
      type: "waitForDomContains",
      text: "Categories Location, Metrics",
      timeoutMs: 60000,
    },
    {
      type: "waitForDomContains",
      text: "Lineage harmonizer://feature/location",
      timeoutMs: 60000,
    },
    {
      type: "waitForEval",
      expression: "(() => { const headers = Array.from(document.querySelectorAll('.forge-report-runtime-table-panel'))[0]?.querySelectorAll('th') || []; const labels = Array.from(headers).map((entry) => (entry.innerText || entry.textContent || '').trim()); return labels.includes('Market') && !labels.includes('Region') && !labels.includes('Metro Area'); })()",
      timeoutMs: 60000,
    },
    {
      type: "waitForEval",
    ...
    {
      type: "screenshot",
      file: "report-builder-preview-semantic-runtime-capacity-location-ladder.png",
      fullPage: true,
    },
  ],
};
