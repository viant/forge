...
import scenario from "../tests/report-builder-preview-semantic-template-saved-payload-export-execution.scenario.mjs";
...
assert.equal(
  scenario.steps.some((step) => step?.type === "screenshot" && String(step.file || "").includes("template-saved-payload-export-execution")),
  true,
);
...
console.log("report-builder-preview-semantic-template-saved-payload-export-execution-scenario-assets ✓ Market Brief saved-payload export execution preserves template, semantic, and artifact semantics end to end");
