...
import scenario from "../tests/report-builder-preview-semantic-reopen-report-document-location-chart-native-detail-error-recovery.scenario.mjs";
...
assert.equal(
  scenario.steps.some((step) => step?.type === "screenshot" && String(step.file || "").includes("location-chart-native-detail-error-recovery")),
  true,
);
...
console.log("report-builder-preview-reopen-report-document-location-chart-native-detail-error-recovery-scenario-assets ✓ reopened location native chart detail failure and recovery preserve runtime resolution");
