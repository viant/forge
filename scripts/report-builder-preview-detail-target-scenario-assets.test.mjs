...
console.log("report-builder-preview-detail-target-scenario-assets ✓ preview scenario covers detail-target editing, rebinding, and preserved runtime mappings");
