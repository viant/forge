...
import scenario from "../tests/report-builder-preview-semantic-import-saved-view-export-artifact-failure.scenario.mjs";
...
assert.equal(
  scenario.steps.some((step) => step?.type === "screenshot" && String(step.file || "").includes("import-saved-view-export-artifact-failure")),
  true,
);
...
console.log("report-builder-preview-import-saved-view-export-artifact-failure-scenario-assets ✓ imported saved-view artifact export artifact failures stay explicit while semantic context remains visible");
