...
import scenario from "../tests/report-builder-preview-semantic-quick-view-table-families.scenario.mjs";
...
assert.equal(
  scenario.steps.some((step) => step?.type === "screenshot" && String(step.file || "").includes("semantic-quick-view-table-families")),
  true,
);
...
console.log("report-builder-preview-semantic-quick-view-table-families-scenario-assets ✓ desktop quick-view table families stay provider-backed and flow into the compiled runtime semantic binding surface");
