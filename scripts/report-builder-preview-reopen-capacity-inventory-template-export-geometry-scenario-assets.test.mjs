...
assert.equal(
  expressions.some((expression) => expression.includes("JSON.stringify(signature) ===") && expression.includes("marginBottom") && expression.includes("scopeFilters__line_1") && expression.includes("channelsFilter:") && expression.includes("primaryTable__row_1__channelV2__text") && expression.includes("Display") && expression.includes("primaryTable__row_2__avails__text") && expression.includes("138200") && expression.includes("primaryChart__svg_page_1") && expression.includes("Inventory Outlook") && expression.includes("headlineKpi__value_0") && expression.includes("Avails: 158400") && expression.includes("headlineKpi__detail_1") && expression.includes("Highlights the leading channel row before drilling") && expression.includes("headlineKpi__detail_2") && expression.includes("page_2__header_title") && expression.includes("page_2__footer_page_number") && expression.includes("Page 2")),
  true,
);
assert.equal(
...
const geometrySummaryIndex = findStepIndex((step) => step?.type === "waitForEval" && String(step?.expression || "").includes("JSON.stringify(signature) ===") && String(step?.expression || "").includes("marginBottom") && String(step?.expression || "").includes("scopeFilters__line_1") && String(step?.expression || "").includes("channelsFilter:") && String(step?.expression || "").includes("primaryTable__row_1__channelV2__text") && String(step?.expression || "").includes("Display") && String(step?.expression || "").includes("primaryTable__row_2__avails__text") && String(step?.expression || "").includes("138200") && String(step?.expression || "").includes("primaryChart__svg_page_1") && String(step?.expression || "").includes("Inventory Outlook") && String(step?.expression || "").includes("headlineKpi__value_0") && String(step?.expression || "").includes("Avails: 158400") && String(step?.expression || "").includes("headlineKpi__detail_1") && String(step?.expression || "").includes("Highlights the leading channel row before drilling") && String(step?.expression || "").includes("headlineKpi__detail_2") && String(step?.expression || "").includes("page_2__header_title") && String(step?.expression || "").includes("page_2__footer_page_number") && String(step?.expression || "").includes("Page 2"));
