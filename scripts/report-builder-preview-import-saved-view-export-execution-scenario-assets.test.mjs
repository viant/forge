...
import scenario from "../tests/report-builder-preview-semantic-import-saved-view-export-execution.scenario.mjs";
...
assert.equal(
  scenario.steps.some((step) => step?.type === "screenshot" && String(step.file || "").includes("import-saved-view-export-execution")),
  true,
);
...
console.log("report-builder-preview-import-saved-view-export-execution-scenario-assets ✓ imported saved-view artifact export execution preserves request, status, artifact, and semantic context end to end");
