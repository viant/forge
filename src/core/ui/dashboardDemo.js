...
export function createDashboardDemoMetadata() {
  return {
    ...
    dataSource: {
      ...
      byState: { selectionMode: 'single', service: { endpoint: 'demo', uri: 'byState' } },
      byDma: { selectionMode: 'single', service: { endpoint: 'demo', uri: 'byDma' } },
      ...
      content: {
        ...
        containers: [
          ...
          },
          {
            ...
            subtitle: 'State tile map with exact-code selection for DMA drilldown',
            columnSpan: 8,
            ...
            geo: {
              ...
              color: {
                field: 'status',
                rules: [
                  { value: 'healthy', label: 'Healthy', color: '#1f8f63' },
                  { value: 'watch', label: 'Watch', color: '#d9822b' },
                  { value: 'critical', label: 'Critical', color: '#c23030' },
                ],
              },
            },
            limit: 5,
          },
          {
            ...
            title: 'DMA / City Detail',
            subtitle: 'Filtered by selected state when a state tile is selected',
            columnSpan: 4,
            dataSourceRef: 'byDma',
            quickFilter: true,
            density: 'compact',
            ...
            columns: [
              ...
              { key: 'dma', label: 'DMA' },
              { key: 'city', label: 'City', type: 'link', link: { href: 'cityDashboardUrl' } },
          ...
          },
          {
            ...
            columns: [
              { key: 'country', label: 'Country', type: 'link', link: { href: 'reportUrl' } },
...
export function createDashboardDemoSeed() {
  return {
    ...
    byCountry: {
      collection: [
        { country: 'US', region: 'NA', spend: 100000, impressions: 4200000, ctr: 2.4, zero_spend_rate: 39.1, status: 'watch', reportUrl: 'https://example.com/demo/reports/country/us' },
        { country: 'CA', region: 'NA', spend: 12000, impressions: 620000, ctr: 2.1, zero_spend_rate: 51.0, status: 'critical', reportUrl: 'https://example.com/demo/reports/country/ca' },
        { country: 'GB', region: 'EMEA', spend: 6000, impressions: 380000, ctr: 2.0, zero_spend_rate: 33.8, status: 'healthy', reportUrl: 'https://example.com/demo/reports/country/gb' },
        { country: 'AU', region: 'APAC', spend: 3000, impressions: 190000, ctr: 1.8, zero_spend_rate: 57.4, status: 'critical', reportUrl: 'https://example.com/demo/reports/country/au' },
        { country: 'DE', region: 'EMEA', spend: 2000, impressions: 160000, ctr: 1.9, zero_spend_rate: 28.6, status: 'watch', reportUrl: 'https://example.com/demo/reports/country/de' },
      ],
    },
    byState: {
      collection: [
        { stateCode: 'CA', stateName: 'California', region: 'NA', spend: 44000, impressions: 1600000, ctr: 2.7, status: 'critical' },
        { stateCode: 'TX', stateName: 'Texas', region: 'NA', spend: 28000, impressions: 990000, ctr: 2.3, status: 'watch' },
        { stateCode: 'NY', stateName: 'New York', region: 'NA', spend: 23000, impressions: 870000, ctr: 2.5, status: 'healthy' },
        { stateCode: 'FL', stateName: 'Florida', region: 'NA', spend: 19000, impressions: 710000, ctr: 2.2, status: 'watch' },
        { stateCode: 'IL', stateName: 'Illinois', region: 'NA', spend: 14000, impressions: 530000, ctr: 2.0, status: 'healthy' },
        { stateCode: 'WA', stateName: 'Washington', region: 'NA', spend: 11000, impressions: 410000, ctr: 2.1, status: 'healthy' },
        { stateCode: 'GA', stateName: 'Georgia', region: 'NA', spend: 9000, impressions: 340000, ctr: 1.9, status: 'watch' },
      ],
    },
    byDma: {
      collection: [
        { stateCode: 'CA', dma: 'Los Angeles', city: 'Los Angeles', cityDashboardUrl: 'https://example.com/demo/dma/los-angeles', spend: 18000, impressions: 620000, status: 'critical' },
        { stateCode: 'CA', dma: 'San Francisco-Oakland-San Jose', city: 'San Francisco', cityDashboardUrl: 'https://example.com/demo/dma/san-francisco', spend: 12000, impressions: 430000, status: 'watch' },
        { stateCode: 'CA', dma: 'San Diego', city: 'San Diego', cityDashboardUrl: 'https://example.com/demo/dma/san-diego', spend: 7000, impressions: 245000, status: 'healthy' },
        { stateCode: 'TX', dma: 'Dallas-Fort Worth', city: 'Dallas', cityDashboardUrl: 'https://example.com/demo/dma/dallas', spend: 11000, impressions: 380000, status: 'watch' },
        { stateCode: 'TX', dma: 'Houston', city: 'Houston', cityDashboardUrl: 'https://example.com/demo/dma/houston', spend: 9000, impressions: 320000, status: 'watch' },
        { stateCode: 'TX', dma: 'Austin', city: 'Austin', cityDashboardUrl: 'https://example.com/demo/dma/austin', spend: 5200, impressions: 180000, status: 'healthy' },
        { stateCode: 'NY', dma: 'New York', city: 'New York', cityDashboardUrl: 'https://example.com/demo/dma/new-york', spend: 17000, impressions: 590000, status: 'healthy' },
        { stateCode: 'NY', dma: 'Buffalo', city: 'Buffalo', cityDashboardUrl: 'https://example.com/demo/dma/buffalo', spend: 2500, impressions: 85000, status: 'healthy' },
        { stateCode: 'FL', dma: 'Miami-Fort Lauderdale', city: 'Miami', cityDashboardUrl: 'https://example.com/demo/dma/miami', spend: 8200, impressions: 300000, status: 'watch' },
        { stateCode: 'FL', dma: 'Tampa-St. Petersburg', city: 'Tampa', cityDashboardUrl: 'https://example.com/demo/dma/tampa', spend: 6100, impressions: 220000, status: 'watch' },
        { stateCode: 'IL', dma: 'Chicago', city: 'Chicago', cityDashboardUrl: 'https://example.com/demo/dma/chicago', spend: 11600, impressions: 420000, status: 'healthy' },
        { stateCode: 'WA', dma: 'Seattle-Tacoma', city: 'Seattle', cityDashboardUrl: 'https://example.com/demo/dma/seattle', spend: 9800, impressions: 350000, status: 'healthy' },
        { stateCode: 'GA', dma: 'Atlanta', city: 'Atlanta', cityDashboardUrl: 'https://example.com/demo/dma/atlanta', spend: 7600, impressions: 280000, status: 'watch' },
      ],
    },
    eligibilityFunnel: {
      collection: [
