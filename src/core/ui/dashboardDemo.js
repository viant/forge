...
export function createDashboardDemoSeed() {
  return {
    ...
    byDma: {
      collection: [
        { stateCode: 'CA', dma: 'Los Angeles', city: 'Los Angeles', spend: 18000, impressions: 620000, status: 'critical' },
        { stateCode: 'CA', dma: 'San Francisco-Oakland-San Jose', city: 'San Francisco', spend: 12000, impressions: 430000, status: 'watch' },
        { stateCode: 'CA', dma: 'San Diego', city: 'San Diego', spend: 7000, impressions: 245000, status: 'healthy' },
        { stateCode: 'TX', dma: 'Dallas-Fort Worth', city: 'Dallas', spend: 11000, impressions: 380000, status: 'watch' },
        { stateCode: 'TX', dma: 'Houston', city: 'Houston', spend: 9000, impressions: 320000, status: 'watch' },
        { stateCode: 'TX', dma: 'Austin', city: 'Austin', spend: 5200, impressions: 180000, status: 'healthy' },
        { stateCode: 'NY', dma: 'New York', city: 'New York', spend: 17000, impressions: 590000, status: 'healthy' },
        { stateCode: 'NY', dma: 'Buffalo', city: 'Buffalo', spend: 2500, impressions: 85000, status: 'healthy' },
        { stateCode: 'FL', dma: 'Miami-Fort Lauderdale', city: 'Miami', spend: 8200, impressions: 300000, status: 'watch' },
        { stateCode: 'FL', dma: 'Tampa-St. Petersburg', city: 'Tampa', spend: 6100, impressions: 220000, status: 'watch' },
        { stateCode: 'IL', dma: 'Chicago', city: 'Chicago', spend: 11600, impressions: 420000, status: 'healthy' },
        { stateCode: 'WA', dma: 'Seattle-Tacoma', city: 'Seattle', spend: 9800, impressions: 350000, status: 'healthy' },
        { stateCode: 'GA', dma: 'Atlanta', city: 'Atlanta', spend: 7600, impressions: 280000, status: 'watch' },
      ],
    },
    eligibilityFunnel: {
      collection: [
