  ...
  const snapshot = {
    ...
    windows: windows.map((w) => {
      ...
      return {
        ...
        inlineMetadata: w.inlineMetadataExplicit === true ? getInlineMetadataSnapshot(w.windowId, options) : undefined,
        inlineMetadataExplicit: w.inlineMetadataExplicit === true,
