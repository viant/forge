...
assert.equal(dashboardCapabilities.blockKinds.includes('dashboard.reportRuntime'), true);
...
assert.equal(dashboardCapabilities.schema.$defs.block.properties.kind.enum.includes('dashboard.reportRuntime'), true);
assert.equal(dashboardCapabilities.schema.$defs.block.properties.dashboard.$ref, '#/$defs/dashboardConfig');
assert.equal(dashboardCapabilities.schema.$defs.block.properties.reportRuntime.$ref, '#/$defs/reportRuntimeConfig');
