...
export function buildAuthoredLandscapeFixtureState() {
  ...
  return {
    ...
    reportPrint: record?.reportPrint || record?.exportRequest?.reportPrint || null,
    pdfReportPrint: record?.reportPrint || record?.exportRequest?.reportPrint || null,
    reportFill: record?.reportFill || record?.exportRequest?.reportFill || null,
    savedReportPayload,
    documentVersion,
    savedAt,
