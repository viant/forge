...
assert.deepEqual(buildReportBuilderDraftExportJobPanelState({
    ...
    title: "Capacity Trend Q3",
    error: "",
    metaChips: ["PDF", "Queued", "Market Brief", "template mismatch"],
    semanticBindingTitle: "Semantic Binding",
    semanticBindingChips: ["Model Ad Delivery"],
...
assert.deepEqual(buildReportBuilderReopenedExportJobPanelState({
    ...
    title: "Capacity Trend Q3",
    error: "",
    metaChips: ["Queued", "Market Brief", "template mismatch"],
    semanticBindingTitle: "Semantic Binding",
    semanticBindingChips: ["Model Ad Delivery"],
    refreshLabel: "Refresh status",
    refreshDisabled: false,
...
assert.deepEqual(buildReportBuilderSavedPayloadExportJobPanelState({
    ...
    requestSummary: {
        ...
        scopeSummaryItems: [{ id: "dateRange", label: "Date Range", value: "2026-08-01 – 2026-08-10" }],
    },
}), {
    tone: "info",
    label: "Saved export",
    ...
    semanticBindingTitle: "Semantic Binding",
    semanticBindingChips: ["Model Ad Delivery"],
    scopeSummaryTitle: "Filters used for this export",
    scopeSummaryText: "Date Range: 2026-08-01 – 2026-08-10 Captured when this export was created. Change filters in the live report before creating another export.",
    scopeSummaryItems: [{ id: "dateRange", label: "Date Range", value: "2026-08-01 – 2026-08-10" }],
    refreshLabel: "Refresh status",
    refreshDisabled: false,
    downloadLabel: "Download artifact",
