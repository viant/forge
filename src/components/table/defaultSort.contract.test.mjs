...
assert.match(basic, /!requestServerTableSort\(\{dataSource, handlers, columnId, direction: newDirection\}\)/, 'sortable header interaction must fail closed when an authored mapping rejects the field');
