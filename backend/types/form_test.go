...
func TestJSONSchemaToFormFields(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expected: []FormField{
				{Name: "b", Label: "B", Type: "string", Widget: "select", Enum: []string{"x", "y"}, Order: 1},
				{Name: "a", Label: "A", Type: "string", Widget: "text", Order: 2},
				{Name: "c", Label: "C", Type: "integer", Widget: "number", Order: 3},
			},
		},
		{
